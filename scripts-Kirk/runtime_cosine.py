...
if __name__ == '__main__':
    ...
    cosine_sims1mil = item_combos1mil.map(lambda x: cosine_sim(x[0], x[1]))
    cosine_sims2mil = item_combos2mil.map(lambda x: cosine_sim(x[0], x[1]))
    cosine_sims3mil = item_combos3mil.map(lambda x: cosine_sim(x[0], x[1]))
    cosine_sims4mil = item_combos4mil.map(lambda x: cosine_sim(x[0], x[1]))
    cosine_sims5mil = item_combos5mil.map(lambda x: cosine_sim(x[0], x[1]))
    cosine_sims6mil = item_combos6mil.map(lambda x: cosine_sim(x[0], x[1]))
    cosine_sims7mil = item_combos7mil.map(lambda x: cosine_sim(x[0], x[1]))
    cosine_sims8mil = item_combos8mil.map(lambda x: cosine_sim(x[0], x[1]))
    cosine_sims9mil = item_combos9mil.map(lambda x: cosine_sim(x[0], x[1]))
    cosine_sims10mil = item_combos10mil.map(lambda x: cosine_sim(x[0], x[1]))
    ...
    start = time.time()
    # cosine_sims2mil_dict = cosine_sims2mil.collectAsMap()
    cosine_sims2mil_dict = cosine_sims2mil.count()
    ...
    start = time.time()
    # cosine_sims3mil_dict = cosine_sims3mil.collectAsMap()
    cosine_sims3mil_dict = cosine_sims3mil.count()
    ...
    start = time.time()
    # cosine_sims4mil_dict = cosine_sims4mil.collectAsMap()
    cosine_sims4mil_dict = cosine_sims4mil.count()
    ...
    start = time.time()
    # cosine_sims5mil_dict = cosine_sims5mil.collectAsMap()
    cosine_sims5mil_dict = cosine_sims5mil.count()
    ...
    start = time.time()
    # cosine_sims6mil_dict = cosine_sims6mil.collectAsMap()
    cosine_sims6mil_dict = cosine_sims6mil.count()
    ...
    start = time.time()
    # cosine_sims7mil_dict = cosine_sims7mil.collectAsMap()
    cosine_sims7mil_dict = cosine_sims7mil.count()
    ...
    start = time.time()
    # cosine_sims8mil_dict = cosine_sims8mil.collectAsMap()
    cosine_sims8mil_dict = cosine_sims8mil.count()
    ...
    start = time.time()
    # cosine_sims9mil_dict = cosine_sims9mil.collectAsMap()
    cosine_sims9mil_dict = cosine_sims9mil.count()
    ...
    start = time.time()
    # cosine_sims10mil_dict = cosine_sims1mil0.collectAsMap()
    cosine_sims10mil_dict = cosine_sims10mil.count()
